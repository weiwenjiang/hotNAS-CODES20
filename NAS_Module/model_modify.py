...
def mobilenet_v2_space(model, args):
    ...
    quan_paras["layers.0"] = [2, 14, True]
    quan_paras["layers.3"] = [2, 14, True]
    quan_paras["layers.6"] = [2, 14, True]
    quan_paras["layers.8.0.layers.0"] = [2, 14, True]
    quan_paras["layers.8.0.layers.3"] = [2, 14, True]
    quan_paras["layers.8.0.layers.6"] = [2, 14, True]
    quan_paras["layers.8.1.layers.0"] = [2, 14, True]
    quan_paras["layers.8.1.layers.3"] = [2, 14, True]
    quan_paras["layers.8.1.layers.6"] = [2, 14, True]
    quan_paras["layers.8.2.layers.0"] = [2, 14, True]
    quan_paras["layers.8.2.layers.3"] = [2, 14, True]
    quan_paras["layers.8.2.layers.6"] = [2, 14, True]
    quan_paras["layers.9.0.layers.0"] = [2, 14, True]
    quan_paras["layers.9.0.layers.3"] = [2, 14, True]
    quan_paras["layers.9.0.layers.6"] = [2, 14, True]
    quan_paras["layers.9.1.layers.0"] = [2, 14, True]
    ...
    quan_paras["layers.10.0.layers.3"] = [2, 14, True]
    quan_paras["layers.10.0.layers.6"] = [2, 14, True]
    quan_paras["layers.10.1.layers.0"] = [2, 14, True]
    quan_paras["layers.10.1.layers.3"] = [2, 14, True]
    quan_paras["layers.10.1.layers.6"] = [2, 14, True]
    ...
    quan_paras["layers.11.1.layers.0"] = [2, 14, True]
    quan_paras["layers.11.1.layers.3"] = [2, 14, True]
    quan_paras["layers.11.1.layers.6"] = [2, 14, True]
    quan_paras["layers.12.0.layers.0"] = [2, 14, True]
    quan_paras["layers.12.0.layers.3"] = [2, 14, True]
    quan_paras["layers.12.0.layers.6"] = [2, 14, True]
    quan_paras["layers.12.1.layers.0"] = [2, 14, True]
    quan_paras["layers.12.1.layers.3"] = [2, 14, True]
    quan_paras["layers.12.1.layers.6"] = [2, 14, True]
    quan_paras["layers.12.2.layers.0"] = [2, 14, True]
    quan_paras["layers.12.2.layers.3"] = [2, 14, True]
    quan_paras["layers.12.2.layers.6"] = [2, 14, True]
    quan_paras["layers.12.3.layers.0"] = [2, 14, True]
    quan_paras["layers.12.3.layers.3"] = [2, 14, True]
    quan_paras["layers.12.3.layers.6"] = [2, 14, True]
    quan_paras["layers.13.0.layers.0"] = [2, 14, True]
    quan_paras["layers.13.0.layers.3"] = [2, 14, True]
    quan_paras["layers.13.0.layers.6"] = [2, 14, True]
    quan_paras["layers.14"] = [2, 14, True]
